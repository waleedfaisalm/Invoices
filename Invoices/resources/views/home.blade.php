									...
									<div class="d-flex">
										<div class="">
											<h3 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{-- number_format(): دلة بتفعل فوصل عشرية للرقم  --}}

                                                {{number_format(\App\Invoices::sum('Total'), 2)}}
                                            </h3>
											<p class="mb-0 tx-12 text-white op-7"> عداد الفواتير {{\App\Invoices::count()}}  </p>
										</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7"> عداد الفواتير الغير مدفوعة  {{\App\Invoices::where('Value_Status', 2)->count()}} </p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">عداد الفواتير المدفوعة   {{\App\Invoices::where('Value_Status', 1)->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">

                                                {{-- round(): دلة تقراب الارقام  --}}
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7"> عداد الفواتير المدفوعة جزئيا  {{\App\Invoices::where('Value_Status', 3)->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
