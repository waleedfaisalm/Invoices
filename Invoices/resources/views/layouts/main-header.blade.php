...
{{-- {{Auth::user()->name}} : dashbord يعرضلي اسم المستخدم الي دخل علا ال   Auth دلة موحودة في نطام ال  --}}
{{-- {{Auth::user()->email}}: dashbord يعرضلي  الايميل الي دخل علا ال   Auth دلة موحودة في نطام ال  --}}
